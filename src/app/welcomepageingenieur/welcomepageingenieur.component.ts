...
@Component({
  selector: 'app-welcomepageingenieur',
  templateUrl: './welcomepageingenieur.component.html',
  styleUrls: ['./welcomepageingenieur.component.css'] 
})
export class welcomepageingenieurComponent  {
